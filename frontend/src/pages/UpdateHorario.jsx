// frontend/src/pages/UpdateHorario.jsx
...
const UpdateHorario = () => {
  const { id } = useParams();
  const [horario, setHorario] = useState(null); // Estado para cargar el horario existente
  ...
  if (!horario) {
    return <div>Cargando horario...</div>; // O un spinner
  }

  return (
    <div>
      <ToastContainer />
      <h1 className='font-black text-4xl text-gray-500'>Actualizar Horario</h1>
      <hr className='my-4 border-t-2 border-gray-300' />
      <p className='mb-8'>Este módulo te permite actualizar un horario existente.</p>
      <form onSubmit={handleSubmit(actualizarHorario)}>
        <div className="mb-4">
